...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Paste any Solana transaction ID and get an AI security verdict in under 2 seconds.',
    type: 'website',
    url: 'https://ai-sentinel-three.vercel.app',
  },
  twitter: { card: 'summary_large_image', title: 'AI-Sentinel', description: 'AI security for Solana transactions' }
}
