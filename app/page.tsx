      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ paddingTop: 60 }}>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            {/* Row 1: System Health + Live Threat */}
            ...
            <div id="scanner" style={{ marginBottom: 32 }}>
              <div style={{ textAlign: 'center', marginBottom: 20, padding: '6px 20px', display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(153,69,255,0.1)', border: '1px solid rgba(153,69,255,0.3)', borderRadius: 30, margin: '0 auto 20px' }}>
            ...
            {/* Row 2: MEV + Address Intel */}
            <div id="mev" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 32 }} className="grid-responsive">
              <MEVDetector />
              <div id="address"><AddressIntelligence /></div>
            </div>
          </div>

          {/* Web3 Explainer for beginners */}
          <Web3Explainer />
...
function ParticleCanvas() {
  return <canvas style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0, opacity: 0.18, pointerEvents: 'none' }} />;
}
